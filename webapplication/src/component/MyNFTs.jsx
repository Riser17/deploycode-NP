...
import '../component/priceslider.css';
import { listOnMarket } from './SmartContracts';
// Function for NFT
                ...
                <div className="p-0" style={{ 'width': '20rem', 'color': 'white' }}>
                  ...
                  <div class="card-body">
                    ...
                    <button id='list' onClick={() => {
                      listOnMarket(element.tokenId, element.Amount);
                    }} class="btn btn-primary" style={{ 'height': '4rem', 'width': '8rem', 'fontSize': '10px' }}>FOR SELL</button>
                  </div>
                </div>
              )}
            </div>
