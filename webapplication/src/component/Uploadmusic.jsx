  ...
  return (
    <>
            ...
            <div id='previewdiv' className='mt-3'>
               ...
               <>
               <img  class="card-img-top p-0" style={{ 'height': '480px', 'width': '800px' }} src={audio} alt="My MUSIC" />
        <audio class=" pt-1" style={{ 'width': '100%' }} controls controlsList="nodownload" >
          <source src={userInfo.filepreview} type="audio/mpeg" />
        </audio>
 </>
        : null}
      {/* previw      */}
               <div className='vertical-center'> 
              <input type='file' name="upload_file" onChange={(e) => MultipleFileChange(e)} single  accept="audio/mp3" />
              </div>
              </div>
            </div>
...
<div className='art'>
              ...
              <span>
              <input type="text"  id='form' onChange={(e) => setCategory(e.target.value)}  value="Music" className="form-control" readonly />
              </span>
              </div>
              <div className='Tags'>
                <h4>
